...
test_cases_for_title_parsing = [
    ...
    ("1080p", ""),
    ("疾速追杀: 芭蕾杀姬/ 捍卫任务: 复仇芭蕾(台)/「基努·里维斯 安娜·德·阿玛斯」 *简繁英字幕", "芭蕾杀姬"),
    ('乐一通大电影: 地球爆炸之日/ 乐一通大战外星人: 粉红末日(台) *(公映/台配)国英3声轨 *官译简繁英字幕', "地球爆炸之日"),
    ('「 Resolution: Native 4K (DoVi) 」Ballerina 2025 2160p BluRay DoVi x265 10bit Atmos TrueHD7.1-WiKi 疾速追杀: 芭蕾杀姬/ 捍卫任务: 复仇芭蕾(台)/「基努·里维斯 安娜·德·阿玛斯」 *(中影公映)国英双语 *官译简繁英字幕', '复仇芭蕾'),
    ('[热门]官组禁转国语中字去头尾广告纯净版以法之名 全36集 | 主演: 张译 李光洁 蒋欣 【去头尾广告纯享版】[仅保留首集片头末集片尾，非伪去头，体积减少30%] ...', ''),
