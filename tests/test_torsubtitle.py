...
test_cases_for_title_parsing = [
    ...
    # ('「 Resolution: Native 4K (DoVi) 」Ballerina 2025 2160p BluRay DoVi x265 10bit Atmos TrueHD7.1-WiKi 疾速追杀: 芭蕾杀姬/ 捍卫任务: 复仇芭蕾(台)/「基努·里维斯 安娜·德·阿玛斯」 *(中影公映)国英双语 *官译简繁英字幕', '疾速追杀: 芭蕾杀姬'),
]   
